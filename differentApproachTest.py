...
from main_class_weighting_augmentation_different_approach import MedicalImageDataset, ModifiedMedicalCNN, INPUT_SIZE
...
# --- Model Yükleme ---
model = ModifiedMedicalCNN(num_classes=NUM_CLASSES)
